...
class _ExampleCupertinoDownloadButtonState
  ...
  void _openDownload(int index) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: Text('Open ${musicList[index]['title']}'),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Flutter Download')),
  ...
  Widget _buildListItem(BuildContext context, int index) {
    ...
    return ListTile(
      leading: DemoAppIcon(index: index),
      title: Text(
...
class DemoAppIcon extends StatelessWidget {
  final int index;
  const DemoAppIcon({super.key, required this.index});
